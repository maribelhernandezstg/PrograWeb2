        ...
        <div className="add_pin_container">
            <div className="side" id="left_side">
                ...
                <div className="section2">
                    ...
                    >
                        ...
                        <div className="upload_img_container">
                            <div id="dotted_border">
                                <div className="pint_mock_icon_container">
                                    <img src="./images/arrow-up.svg" alt="upload_img" className="pint_mock_icon" />
                                </div>
                                <div>Click to upload</div>
                                <div>Recommendation: Use hight-quality .jpg less tah 20MB</div>
                            </div>
                        </div>
                    ...
                    <div className="modals_pin"
                        style={{display: showModalPin ? 'block' :'none'}}
                    >
            ...
            <div className="side" id="right_side">
                ...
                <div className="section2">
                    ...
                    <input placeholder="Tell everone what your pin is about" type="text" className="new_pin_input" id="pin_description" />
